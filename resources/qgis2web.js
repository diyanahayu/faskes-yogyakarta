...
map.getView().fit([12281156.821042, -875517.107644, 12296455.571174, -866427.198224], map.getSize());
...
setTimeout(function() {
    var legendPanel = document.getElementsByClassName('layer-switcher-panel')[0];
    if (legendPanel) {
        var title = document.createElement('div');
      title.innerHTML = "<div style='text-align:center; font-size:14px; font-weight:bold;'>Keterangan</div><br>";
        legendPanel.prepend(title);
    }
}, 1000);
